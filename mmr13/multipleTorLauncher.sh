...
do
    ...
    tor --RunAsDaemon 1 --CookieAuthentication 0 --HashedControlPassword "16:E35FB780CF3BF47E6054EDCF3C6B57FACE5E5EEB5151827F702BE3944D" --ControlPort $control_port --PidFile tor$i.pid --SocksPort $socks_port --DataDirectory data/tor$i
done
